var urlPractice70442648D1E34511A98C5D3C1D66B075_DEBUG;
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
class Heading extends FormattingSettingsCard {
    heading = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .TextInput */ .oi({
        name: "Heading",
        displayName: "Title",
        value: "",
        placeholder: "Enter Your Title"
    });
    subHeading = new powerbi_visuals_utils_formattingmodel__WEBPACK_IMPORTED_MODULE_0__/* .TextInput */ .oi({
        name: "subHeading",
    ...
    name = "dataPoint";
    displayName = "Title";
    slices = [this.heading, this.subHeading];
}
/**
...
class Visual {
    ...
    update(options) {
        ...
        let headingValue = this.formattingSettings.heading.heading.value || "";
        this.h2.innerText = headingValue;
        let subHeadingValue = this.formattingSettings.heading.subHeading.value;
        this.h4.innerText = subHeadingValue;
        //draw header
        const tableHeader = document.createElement("th");
        tableDataView.columns.forEach((column) => {
...
var urlPractice70442648D1E34511A98C5D3C1D66B075_DEBUG = {
    name: 'urlPractice70442648D1E34511A98C5D3C1D66B075_DEBUG',
    displayName: 'UrlPractice',
    class: 'Visual',
    apiVersion: '5.3.0',
    create: (options) => {
...
if (typeof powerbi !== "undefined") {
    ...
    powerbi.visuals.plugins["urlPractice70442648D1E34511A98C5D3C1D66B075_DEBUG"] = urlPractice70442648D1E34511A98C5D3C1D66B075_DEBUG;
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (urlPractice70442648D1E34511A98C5D3C1D66B075_DEBUG);

})();

urlPractice70442648D1E34511A98C5D3C1D66B075_DEBUG = __webpack_exports__;
/******/ })()
;
